...
> **封存說明（2026-09-12）**：這份文件記錄 `v3-0908.x` 的設計與當時缺陷，供歷史稽核，不是目前操作規格。現行版本是 `v3-0912.1`；請改讀 [Clone 後首次啟動](getting-started.md)、[最終審查](final-review-2026-09-12.md) 與 [版本紀錄](../CHANGELOG.md)。
